(function(){
  ...
  load('/assets/enhancements-core.js?v=8',function(){if(!isMainGuide())return;load('/assets/market-2026.js?v=4',function(){load('/assets/market-2026-report.js?v=1',function(){load('/assets/market-coverage-ui.js?v=2',function(){load('/assets/market-sales-ui.js?v=2')})})})})
})();