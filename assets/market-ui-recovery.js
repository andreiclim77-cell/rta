...
var MODULES=[
 {id:'marketManagementCockpit',src:'/assets/market-management-v2.js?v=9'},
 {id:'marketAnalysisSynthesis',src:'/assets/market-analysis-synthesis.js?v=6'},
 {id:'marketHypeRadar',src:'/assets/market-hype-ui.js?v=13'},
 {id:'marketViewSwitcher',src:'/assets/market-view-switcher.js?v=10'}
];
