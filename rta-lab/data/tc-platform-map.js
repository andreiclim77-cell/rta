...
(() => {
  ...
  buildOutput = function(atom, wire, liquid) {
    ...
    if (atom.id === "gtr") {
      ...
      output.note = "Dicodes/Resistherm NiFe30 · TCR 320 · Ø2,5 mm · 7 spire este potrivirea TC naturală a GTR pentru finețe, layering, smoothness și consistență termică.";
      return output;
    }
    ...
    if (atom.id === "kx") {
      ...
      output.noteClass = "valid";
      output.note = "Dicodes/Resistherm NiFe30 · TCR 320 · Ø2,5 mm · 7 spire rămâne configurația TC validată ca extraordinară pe KX: smooth, constantă și foarte naturală pe platformă.";
      return output;
    }
    ...
    if (atom.id === "kprime") {
      ...
      output.note = "Zivipf NiFe52 · TCR 310 · Ø2,5 mm · 6 spire este direcția TC curent preferată pe K Prime: coil compact, răspuns prompt și R0 confortabilă. NiFe30/7 rămâne benchmark-ul istoric pe lichidul personal 80% trabuc / 20% cireșe; nu se declară încă superioritate universală fără A/B cross-alloy dedicat.";
      return output;
    }
  ...
  if (baseComparisonText) {
    comparisonText = function(atom, wire, output) {
      ...
      if (!atom || !wire || wire.id !== "nife30") return base;
      if (atom.id === "gtr") return "+ NiFe30 Dicodes 320/7 = finețe, layering și consistență; potrivire TC naturală validată.";
      if (atom.id === "kx") return "+ NiFe30 Dicodes 320/7 = smoothness și consistență; configurație TC validată ca extraordinară.";
  ...
  if (baseExplorerVapeText) {
    explorerVapeText = function(atom, wire, output) {
      ...
      if (atom.id === "gtr") return "VALIDAT: Dicodes/Resistherm NiFe30 · TCR320 · 7 spire este potrivirea TC naturală a GTR.";
      if (atom.id === "kx") return "VALIDAT: Dicodes/Resistherm NiFe30 · TCR320 · 7 spire este extraordinar și natural pe KX.";
