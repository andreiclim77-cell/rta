...
need(hypeFlow.includes("cron: '0 3 * * *'")&&hypeFlow.includes("cron: '0 4 * * *'")&&hypeFlow.includes("cron: '0 5 * * *'")&&hypeFlow.includes('Europe/Bucharest'),'Hype 06:00 primary + 07:00 fallback schedule missing');
console.log('Market final gate OK: Analysis=Romania; Hype=GLOBAL exact ±30d, product-level, upstream+multi-vendor+Pre-Order recovery, final category anchors enforced, 06:00 primary + 07:00 fallback; password every entry; cache v37.');
