...
for(const asset of ['/assets/market-loading-guard.js?v=15','/assets/market-ui-recovery.js?v=9','/assets/market-hype-ui.js?v=10','/assets/market-view-switcher.js?v=8','/assets/market-access-policy.js?v=2'])need(enhancements.includes(asset),`Loader is not on final asset ${asset}`);
for(const asset of ['/assets/market-loading-guard.js?v=15','/assets/market-ui-recovery.js?v=9','/assets/market-hype-ui.js?v=10','/assets/market-hype-ui.css?v=8','/assets/market-view-switcher.js?v=8','/assets/market-source-info.js?v=3','/assets/market-access-policy.js?v=2'])need(sw.includes(asset),`Service worker is not on final asset ${asset}`);
need(sw.includes('ghid-rta-static-v40-hype-source-layers'),'Final service worker cache version missing');
...
need(recovery.includes('market-hype-ui.js?v=10'),'Recovery can inject old Hype UI');
...
need(hype.includes('catalogBlock')&&hype.includes('CATALOG MONITORIZAT · SEPARAT DE HYPE')&&hype.includes('Originale și clone, fără amestec')&&hype.includes('Clone declarate'),'Current catalog, originals and clones are not separated in the Hype UI');
for(const label of ['Lansări 30 + 30','Semnale publice','Catalog monitorizat','Căutate, fără eveniment datat confirmat'])need(hype.includes(label),`Hype evidence layer missing: ${label}`);
...
need(hype.includes('Memoria de 180 de zile împiedică relistările vechi')&&hype.includes('Lansările datate, semnalele și catalogul'),'UI does not explain relisting/release/catalog distinction');
