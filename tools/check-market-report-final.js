...
for(const asset of ['/assets/market-loading-guard.js?v=15','/assets/market-ui-recovery.js?v=9','/assets/market-hype-ui.js?v=11','/assets/market-view-switcher.js?v=8','/assets/market-access-policy.js?v=2'])need(enhancements.includes(asset),`Loader is not on final asset ${asset}`);
for(const asset of ['/assets/market-loading-guard.js?v=15','/assets/market-ui-recovery.js?v=9','/assets/market-hype-ui.js?v=11','/assets/market-hype-ui.css?v=9','/assets/market-view-switcher.js?v=8','/assets/market-source-info.js?v=3','/assets/market-access-policy.js?v=2'])need(sw.includes(asset),`Service worker is not on final asset ${asset}`);
need(sw.includes('ghid-rta-static-v41-hype-clear-language'),'Final service worker cache version missing');
...
need(recovery.includes('market-hype-ui.js?v=11'),'Recovery can inject old Hype UI');
