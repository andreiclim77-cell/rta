...
html = html
  ...
  .replace(/<title>[^<]*<\/title>/, '<title>MTL RTA Guide - Smokee | atomizers, wires and builds</title>')
  .replace(/<meta name="title" content="[^"]*"\s*\/>/, '<meta name="title" content="MTL RTA Guide - Smokee | atomizers, wires and builds" />')
  .replace(/<meta name="description" content="[^"]*"\s*\/>/, '<meta name="description" content="MTL RTA guide for atomizers, wires, builds, temperature control, taste diagnosis, reviews, mods and Smokee supplies." />')
  .replace(/<meta name="keywords" content="[^"]*"\s*\/>/, '<meta name="keywords" content="MTL RTA guide, MTL atomizers, RTA wires, MTL builds, temperature control, taste diagnosis, Smokee, rebuildable atomizers" />')
  ...
  .replace(/<meta property="og:title" content="[^"]*"\s*\/>/, '<meta property="og:title" content="MTL RTA Guide - Smokee | atomizers, wires and builds" />')
  .replace(/<meta property="og:description" content="[^"]*"\s*\/>/, '<meta property="og:description" content="MTL RTA guide for atomizers, wires, builds, reviews, temperature control, mods and Smokee supplies." />')
  ...
  .replace(/<meta name="twitter:description" content="[^"]*"\s*\/>/, '<meta name="twitter:description" content="MTL RTA guide for atomizers, wires, builds, reviews and temperature control." />')
