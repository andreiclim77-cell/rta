...
const sales={
  ...
  rankingHistory:[{
    date:'2026-09-05',
    rows:[
      {retailerId:'shop-a',category:'POD',brand:'OXVA',product:'OXVA XLIM Pro 3',rank:1,productUrl:'https://shop-a.test/xlim-pro-3'},
      {retailerId:'shop-a-alias',category:'POD',brand:'OXVA',product:'OXVA XLIM Pro 3 Black',rank:2,productUrl:'https://shop-a-alias.test/xlim-pro-3'},
